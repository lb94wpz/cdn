document.addEventListener('DOMContentLoaded', function () {
    const defaultEncoding = 2 // 网站默认语言，1: 繁體中文, 2: 简体中文
    const translateDelay = 0 // 延迟翻译时间, 如100表示100ms, 默认为0
    let currentEncoding = defaultEncoding
    const targetEncodingCookie = 'translate-tw-cn'
    let targetEncoding = localStorage.getItem(targetEncodingCookie) ? Number(localStorage.getItem(targetEncodingCookie)) : defaultEncoding
